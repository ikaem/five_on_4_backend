...
// class AnotherAuthorizationMiddleware {
...
//   const AnotherAuthorizationMiddleware({
//     required FutureOr<Response?> Function(Request) onValidateRequest,
//   }) : _onValidateRequest = onValidateRequest;

// // TODO these could  be  validators
// // TODO and then we could have one middleware class, and just pass validators inside
//   final FutureOr<Response?> Function(Request) _onValidateRequest;

//   Middleware call() {
//     // TODO testing only
//     final middleware = createMiddleware(
//       requestHandler: _onValidateRequest,
//     );
//     return middleware;
